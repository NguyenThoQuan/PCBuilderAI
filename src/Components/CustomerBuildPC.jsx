...
import "../Styles/CustomerBuildPC.scss";

export default function CustomerBuildPC() {
        ...
        <>
            {
                loading ?
                    ...
                    (
                        isBuildPC === true ?
                            <BuildPC money={money} selectedOption={selectedOption} handleStartOver={handleStartOver} />
                            :
                            <form>
